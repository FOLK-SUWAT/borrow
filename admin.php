                ...
                <div class="row">
                    <div class="col-md-12 col-md-offset-2" style="padding-top: 25px">
                        ...
                        <div class="row row_topic">
                            <div class="col-md-4">
                                <h1 class="index_topic">ข้อมูลสมาชิก</h1>
                            </div>
                            <div class="col-md-3 row_search">
                                <input type="text" ng-model="search" class="form-control" placeholder="Search">
                            </div>
                            <div class="col-md-5 row_btn">
                                <button href="" class="btn btn-Send" ng-click="showAdd()"><i class="fa fa-plus"></i> เพิ่ม สมาชิก</button>
                                <a href="department.php" class="btn btn-Send"><i class="fa fa-plus"></i> เพิ่มแผนก</a>
                            </div>
                        </div>
                        <table class="table table-bordered table-striped" style="margin-top:10px;">
                            <thead>
                                <tr>
                                    <th ng-click="sort('mem_name')" class="text-center">First Name
                                        <span class="pull-right">
                                            <i class="fa fa-sort gray" ng-show="sortKey!='mem_name'"></i>
                                            <i class="fa fa-sort" ng-show="sortKey=='mem_name'" ng-class="{'fa fa-sort-asc':reverse,'fa fa-sort-desc':!reverse}"></i>
                                        </span>
                                    </th>
                                    ...
                                    <th ng-click="sort('department')" class="text-center">Department
                                        <span class="pull-right">
                                            <i class="fa fa-sort gray" ng-show="sortKey!='department'"></i>
                                            <i class="fa fa-sort" ng-show="sortKey=='department'" ng-class="{'fa fa-sort-asc':reverse,'fa fa-sort-desc':!reverse}"></i>
                                        </span>
                                    </th>
                                    <th ng-click="sort('mem_type_id')" class="text-center">Type ID
                                        <span class="pull-right">
                            ...
                            <tbody>
                                <tr dir-paginate="member in member|orderBy:sortKey:reverse|filter:search|itemsPerPage:15">
                                    <td>{{ member.mem_name }}</td>
                                    <td>{{ member.email }}</td>
                                    <td>{{ member.mem_type_department}}</td>
                                    <td>{{ member.mem_type_id }}</td>
