    ...
    <body>
        <div class="container">
            ...
            <div class=" row" style="margin-bottom: 25px;">
                ...
                <textarea disabled rows="4" cols="135"><?php echo $row_borrow_detail['detail']; ?></textarea>
                </div>
            </div>
            <div class="row">
                <table class="table table-bordered table-striped" style="margin-top:10px; text-align: center">
                    ...
                    <tbody>
                        <!-- ตาราง ajax  -->
                        <?php @include('cutstock_show.php') ?>
                        <?php @include('cutstock_fetch.php') ?>
            ...
            <div class="modal-body">
                ...
                <form role="form">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="inputName" placeholder=" <?php echo $SQL['mem_name']; ?>" value="<?php echo $SQL['mem_name']; ?>" disabled/>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail">Email</label>
                        <input type="email" class="form-control" id="inputEmail" placeholder=" <?php echo $SQL['email']; ?>" value="  <?php echo $SQL['email']; ?>"disabled/>
                    </div>
                    <div class="form-group">
