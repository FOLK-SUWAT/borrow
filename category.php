				...
				<div class="row">
					<div class="col-md-12 col-md-offset-2" style="padding-top: 25px">
						...
						<div class="row row_topic">
							<div class="col-md-4">
								<h1 class="index_topic">หมวดหมู่อุปกรณ์</h1>
							</div>
							<div class="col-md-3 row_search">
								<input type="text" ng-model="search" class="form-control" placeholder="Search">
							</div>
							<div class="col-md-5 row_btn">
								<button href="" class="btn btn-Send" ng-click="showAdd()"><i class="fa fa-plus"></i> เพิ่ม หมวดหมู่อุปกรณ์</button>
								<a href="manager.php" class="btn btn-primary"></i> กลับหน้าหลัก</a>
							</div>
					...
					<table class="table table-bordered table-striped" style="margin-top:10px;">
						<thead>
							<tr>
								<th ng-click="sort('cat_name')" class="text-center">รหัสหมวดหมู่
								...
								<th ng-click="sort('type_name')" class="text-center">หมวดหมู่
									<span class="pull-right">
						...
						<tbody>
							<tr dir-paginate="cat in cat|orderBy:sortKey:reverse|filter:search|itemsPerPage:10">
								...
								<td>
									<button type="button" class="btn btn-success" ng-click="showEdit(); selectcat(cat);"><i class="fa fa-edit"></i> Edit</button>
									<button type="button" class="btn btn-danger" ng-click="showDelete(); selectcat(cat);"> <i class="fa fa-trash"></i> Delete</button>
								</td>
